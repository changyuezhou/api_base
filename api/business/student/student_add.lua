...
function business:do_action(tbl)
    ...
    -- 检查名称是否重复
    local check = require "student_check"
    ...
    tbl.have_courses = business:covert_array_to_string(tbl.have_courses)
    tbl.course_grade = business:covert_array_to_string(tbl.course_grade)

    -- 添加记录到数据库
    local configure = require "configure"
    local dao = require "dao"
    local table_name = configure.DBCService.DB .. ".t_student"
